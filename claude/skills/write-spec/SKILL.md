---
name: write-spec
description: Produce a structured project spec, generate/update CLAUDE.md and architecture docs for a project
disable-model-invocation: true
argument-hint: "[project name, topic, or path to existing summary]"
---

# Write Spec

You are helping the user produce a structured project specification, along with CLAUDE.md and architecture documentation.
...
- Check the codebase, CLAUDE.md, conversation history, and general knowledge before asking anything.
...
- If no CLAUDE.md exists: create one with project-specific instructions derived from the spec.
