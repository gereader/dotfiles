---
name: grill-me
description: Guided discovery session — ask smart questions to build a complete picture of a topic, project, or problem. Use when the user wants to explore a problem space, clarify requirements, or think through a project before building.
---
...
- Read the codebase: AGENTS.md, project structure, existing docs, relevant source files.
